...
ECHO mkdir -p %1 >> cmd.dat

plink %PASS% %ID%@%HOST% -m cmd.dat

:: send code.f90 to host
pscp %PASS% code.f90 %POSI%code.f90

:: compile .f90 file
ECHO cd ~/%HSAVE%/%1 > cmd.dat
...
START ftp://140.115.36.36/%FTPOSI%%1/
